...
import { audienceMenus, guideLinks, guidesPanel } from "./data/data";
      ...
      <NavigationMenu.List className={styles.List}>
        <NavigationMenu.Item>
          ...
          <NavigationMenu.Content
            className={`${styles.Content} ${styles.GuidesContent}`}
          >
...
function Link(props: NavigationMenu.Link.Props) {
  return (
    <NavigationMenu.Link
      render={
        // Replace <a /> with your framework's Link component if needed.
        <a />
      }
      {...props}
    />
